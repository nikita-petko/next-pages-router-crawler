...
export enum ExperimentOperationStatus {
  ...
  // "RollingOut" is used for switching the variant after an experiment has been stopped,
  // while "Stopping" only applies to experiments that are currently running.
