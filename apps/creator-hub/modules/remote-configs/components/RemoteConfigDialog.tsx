...
import CreateOrEditDialog, { CreateOrEditResult, EditDialogProps } from './CreateOrEditDialog';
import SnippetDialog from './SnippetDialog';
import PublishDialog from './PublishDialog';
import { TSnippetGenerationFunction } from '../utils/generateSnippet';
...
const RemoteConfigDialog = ({
  ...
  const snippetDialog = useMemo(() => {
    if (dialogState?.type !== 'snippet') return null;
  ...
  const publishDialog = useMemo(() => {
    if (dialogState?.type !== 'publish') return null;
