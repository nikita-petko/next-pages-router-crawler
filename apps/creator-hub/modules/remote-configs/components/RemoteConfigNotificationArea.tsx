...
import ActionButtonGroup, { ActionsInGroup } from './ActionButtonGroup';
...
const RemoteConfigNotificationArea = ({
  ...
  isDisabledDueToMissingDraftHash = false,
  onDiscard,
  onCancelPublish,
  onPublish,
  onForcePublish,
  ...
  const stagedConfigsAndRuleOrderingTitle = tPendingTranslation(
    `You have ${draftCount} staged configs and staged rule ordering changes.`,
            ...
            actions: [
              {
                ...
                onAction: publishNow,
                isDisabled: isDisabledDueToMissingDraftHash || isPublishing || !canPublish,
  ...
  if (!notificationAreaSpec) return [];
