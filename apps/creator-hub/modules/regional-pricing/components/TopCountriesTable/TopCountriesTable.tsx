...
import type { RegionalPriceDisplayInfo } from '../../types';
...
type Props = {
  ...
  // TODO(jeminpark): remove this prop - it should be determined by the parent
  isForSale?: boolean;
  className?: string;
};
...
function TopCountriesTable({
  ...
  return (
    <TableContainer
      // TODO(jeminpark): dimming behavior should belong to the parent - migrate this out
      className={clsx('max-width-[678px]', isForSale !== false || 'opacity-[0.5]', className)}>
      <Table>
        <TableHead>
          <TableRow>
