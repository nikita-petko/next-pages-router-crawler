...
import type { TranslationAnalyticsMetadataResponse } from '@modules/clients/gameInternationalization';
import gameInternationalizationClient, {
  DownloadReportType,
  ReportStatus,
  RequestReportType,
} from '@modules/clients/gameInternationalization';
import type { ErrorType } from '@modules/clients/types';
  ...
  const initiateDownload = useCallback(async () => {
    try {
      if (typeof reportTypeTargetId === 'undefined') {
        throw new TypeError('Report type id is undefined');
      }
