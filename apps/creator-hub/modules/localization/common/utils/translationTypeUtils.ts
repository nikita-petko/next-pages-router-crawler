import { RobloxGameInternationalizationApiGetNameDescriptionHistoryV2RequestContentTypeEnum as TranslationProductType } from '@rbx/client-gameinternationalization/v1';
