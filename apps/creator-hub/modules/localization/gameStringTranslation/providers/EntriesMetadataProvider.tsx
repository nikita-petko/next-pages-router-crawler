import { ChangeAgentType, TranslationEntryTable } from '@modules/clients';
...
import { EntryManagementActionTypes, EntryTableState } from '../entryManagementActionTypes';
import EntriesMetadataContext, { EntriesMetadataValue } from './EntriesMetadataContext';
import useEntryInformation from '../hooks/useEntryInformation';

const EntriesMetadataProvider: FunctionComponent<React.PropsWithChildren<unknown>> = ({
  children,
}) => {
          ...
          translations:
            entry.translations?.map((translation) => {
              return {
                ...
                translation: {
                  translationText: translation.translationText?.replace(/\n/g, ' ') ?? '',
