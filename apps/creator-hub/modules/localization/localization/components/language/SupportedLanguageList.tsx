...
import type { LanguageDetailedInfo } from '../../types/LanguageInfo';
  ...
  const supportedLanguagesList = useMemo(() => {
    ...
    return languageInfoList.map((language) => (
      <LanguageItem
        ...
        isImageAutoTranslationAvailable={language.isImageAutoTranslationAvailable}
        isImageAutoTranslationOn={language.isImageAutoTranslationOn}
