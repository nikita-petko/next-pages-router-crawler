...
import GameStatus from '@modules/creations/game/components/GameStatus';
...
import type { MenuItem as LeftNavigationMenuItem } from '@modules/navigation/leftNavigation/interface/menuItem';
...
const LeftNavigation: FunctionComponent<React.PropsWithChildren> = () => {
