...
import { formatDurationInSecond } from '@modules/charts-generic/charts/formatters/timeFormatters';
...
const ServerMemoryDumpsTable: FC = () => {
  ...
  const rowData = useMemo(() => {
    return data.map((crash) => {
      ...
      return new Map<CrashesTableColumnKey, CellDataType<CrashesTableActionType>>([
        [
