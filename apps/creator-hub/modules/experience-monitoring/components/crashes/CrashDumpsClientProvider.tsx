...
import type { PaginationResponse, NonPaginatedRequest } from '@modules/experience-analytics-shared';
...
const crashDumpFileQueryOptions = (dumpId: string | null) => ({
  ...
  queryFn: () => fetchCrashDumpFileAsTreemap((dumpId ?? '') as string),
 ...
 */
export function useCrashDumpFileQuery(
  dumpId: string | null,
): UseQueryResult<SingleTreemapSeries, Error> {
  return useQuery({
...
const CrashDumpsClientProvider: FunctionComponent<React.PropsWithChildren<unknown>> = ({
  children,
}) => {
