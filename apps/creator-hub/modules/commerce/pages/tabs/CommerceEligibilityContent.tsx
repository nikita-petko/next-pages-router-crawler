...
import {
  userAgreementsClient,
  AgreementResolutionResponse,
  UserAgreementClientType,
...
const EligibilityRow: FunctionComponent<EligibilityRowProps> = ({
  isEligible,
  isFetching,
  icon,
  headingText,
...
const CommerceEligibilityContent: FunctionComponent = () => {
