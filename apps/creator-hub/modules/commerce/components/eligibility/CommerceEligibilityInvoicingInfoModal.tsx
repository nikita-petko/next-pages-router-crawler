...
import { CreatorContactInfo } from '@modules/clients/brandPlatform';

export interface CommerceEligibilityInvoicingInfoModalProps {
  onCancel: () => void;
...
const CommerceEligibilityInvoicingInfoModal: FunctionComponent<
  CommerceEligibilityInvoicingInfoModalProps
> = ({ onCancel, onSubmit, countries, legalContactInfo }) => {
