...
import type { CreatorAccountInfo, CreatorContactInfo } from '@modules/clients/brandPlatform';
...
interface CommerceEligibilityBusinessInfoModalProps {
  onCancel: () => void;
 ...
 */
const CommerceEligibilityBusinessInfoModal = ({
  onCancel,
  onSubmit,
  countries,
  accountInfo,
