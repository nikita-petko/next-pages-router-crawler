...
import type { CommerceProductBundlingFeeModel } from '@rbx/client-commerce-api/v1';
import { CommerceProductBundlingFeeStatus } from '@rbx/client-commerce-api/v1';
...
interface BundlingFeeDisplayProps {
  bundlingFee: CommerceProductBundlingFeeModel | null | undefined;
  onAcceptBundlingFee: () => void;
}

const BundlingFeeDisplay = ({ bundlingFee, onAcceptBundlingFee }: BundlingFeeDisplayProps) => {
