...
import { MerchantDetail } from '@modules/commerce/configs/merchantConfigs';

export interface CommerceMerchantCardProps {
...
const CommerceSelectMerchantCard: FunctionComponent<CommerceMerchantCardProps> = ({
  merchantDetail,
  selected,
  onClick,
}) => {
