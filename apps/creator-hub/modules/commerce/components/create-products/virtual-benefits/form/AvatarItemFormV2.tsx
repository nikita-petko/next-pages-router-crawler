...
import type { AvatarItemDropdown } from '../../../../constants/avatarItemConfigurationConstants';
import {
  ...
  const fetchAvatarItems = useCallback(
    async (
      ...
      const {
        ...
        isBundle ? undefined : translateAssetType(avatarSubCategoryDetails.assetType!),
      );
