 ...
 */
// oxlint-disable-next-line react/react-compiler -- pre-existing: react-hook-form watch() is incompatible with React Compiler memoization
const CommerceItemsTable = ({
  commerceItems,
  showCheckboxes,
  ...
  const { control, watch, setValue, reset, register, unregister } = useForm({
