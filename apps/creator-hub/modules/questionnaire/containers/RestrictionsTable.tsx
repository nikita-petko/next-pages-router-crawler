...
const RestrictionsTable: FunctionComponent<React.PropsWithChildren<RestrictionsTableProps>> = ({
  ...
  return (
    <div className={tableContainer}>
      <Table
        aria-label={translate('Title.ComplianceTable')}
        className={`${table} ${restrictionsTable}`}>
        <TableHead>
          <TableRow>
            <TableCell className={restrictionsFirstColumnHeader}>
              <div className={tooltip}>
                <Typography className={restrictionsHeaderText} variant='tableHead'>
        ...
        <TableBody>
          {restrictedCountries.length > 0 ? (
                  ...
                  <TableRow
                    ...
                    <TableCell>
                      <Typography variant='body2'>
                        {countryRestriction.displayCountryName}
                      </Typography>
                    </TableCell>
                    <TableCell>
                      <Typography variant='body2'>
            ...
            <TableRow>
              <TableCell>
                <Typography variant='body2'>
                  {translate('Message.NoRestrictedCountries')}
                </Typography>
              </TableCell>
              <TableCell>
