...
import type { V2Beta1Moderation } from '@rbx/client-experience-guidelines-service/v1';
import {
  Dialog,
  DialogContent,
  DialogBody,
  ...
  return (
    <Dialog
      ...
      <DialogContent
        ...
        <DialogBody className='flex flex-col gap-large min-height-[0px]'>
        ...
        <DialogFooter className='flex items-center justify-end gap-small'>
          {/* <span className='text-body-medium content-default'>
            {translate(
              'Description.AppealOwnerOnly',
            )}
          </span>
          <Button onClick={onClose} variant='Emphasis' size='Medium'>
            {translate('Action.AcceptChanges')}
          </Button> */}
          <Button
            as='a'
            ...
            size='Medium'>
            {translate(
              'Action.AppealDecision' /* in TranslationNamespace.DeveloperQuestionnaire */,
            )}
          </Button>
        </DialogFooter>
      </DialogContent>
