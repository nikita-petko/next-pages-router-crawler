...
import { shuffle } from '@modules/miscellaneous/utils';
import type { TNextStepsTopic } from '../../constants/nextStepsConstants';
import { nextStepsTopics } from '../../constants/nextStepsConstants';
...
const NextSteps: FunctionComponent<React.PropsWithChildren> = () => {
