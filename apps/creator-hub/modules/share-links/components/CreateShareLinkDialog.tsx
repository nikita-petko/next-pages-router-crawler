...
} from '@modules/react-query/affiliateLinks';
...
export type TAffiliateLinkForm = {
  experience?: TExperience;
  campaignName: string;
  launchData?: string;
  launchDataEnabled: boolean;
  fallbackToHome?: boolean; // Optional field for users who are AllowedToCreateForAnyExperience
};
