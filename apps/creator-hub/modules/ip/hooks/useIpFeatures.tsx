...
import { NavigationFeatureManager, Feature } from '@modules/navigation/feature';
...
const menuItems: Feature<IpSettings>[] = [
  {
    ...
    subFeatures: [
      ...
      },
      {
        ...
        isEnabledOnSettings: (settings) =>
          settings?.enableOnDemandSearch === true &&
...
const useIpNavSettings = () => {
  ...
  const ipNavSettings: IpSettings = useMemo(() => {
    return {
      ...
      enableOnDemandSearch: features?.enableTopExperienceMatch || !!params?.enableOnDemandSearch, // experience owners can see matches
