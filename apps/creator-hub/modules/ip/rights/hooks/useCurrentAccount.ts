...
import type { AccountFlag } from '@rbx/client-rights/v1';
import { AccountFlagFlagNameEnum } from '@rbx/client-rights/v1';
import rightsClient from '@modules/clients/rights';
// import { Account, User } from @rbx/client-rights/v1';
