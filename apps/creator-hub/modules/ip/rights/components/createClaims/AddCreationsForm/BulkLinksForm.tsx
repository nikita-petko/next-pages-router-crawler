...
import { AccountAccountTypeEnum, ClaimItemSourceEnum } from '@rbx/clients/rightsV1';
...
import { AddCreationsFields } from './AddCreationsForm';
import ControlledDescription from '../../common/ControlledDescription';
import { useCurrentAccountContext } from '../../../../components/AccountProvider';

export const PLACEHOLDER_CREATION_LINK = `https://www.${process.env.robloxSiteDomain}/games/1234567891/Roblox-Game`;
export const COPYRIGHT_EMAIL = 'copyright_agent@roblox.com';
export const MAX_CLAIM_REQUESTS = 250;
      ...
      <Grid item XSmall container spacing={3} marginBottom='40px'>
        ...
        <Grid item XSmall={12} Large={12}>
          <Controller
            ...
            rules={{
              validate: {
                required: (value) => value.findIndex((val: string) => val.length > 0) !== -1,
