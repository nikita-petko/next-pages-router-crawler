...
import { ClaimContentContentTypeEnum, ClaimItemStatusEnum } from '@rbx/clients/rightsV1';
import { useRouter } from 'next/router';
import { ClaimItemOverride } from '@modules/clients/rights';
...
const ClaimAgainstMeRow = ({ claimItems }: { claimItems: ClaimItemOverride[] }) => {
  ...
  const respondURL = ClaimsAgainstContentURL(contentType, contentId.toString());
