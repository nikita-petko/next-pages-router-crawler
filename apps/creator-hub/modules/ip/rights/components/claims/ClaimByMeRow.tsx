...
import { VIEW_CLAIM_ITEM_HREF } from '../../urls';
import { ClaimPages } from '../claimItem/ViewClaimItemContainer';
...
const ClaimByMeRow = ({ claim }: { claim: ClaimItem }) => {
  ...
  const viewClaimItemURL = VIEW_CLAIM_ITEM_HREF(claim.claimId || '', claim.id || '');
