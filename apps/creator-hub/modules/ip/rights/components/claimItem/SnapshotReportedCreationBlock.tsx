...
import type { ClaimItem, ClaimItemView } from '@rbx/client-rights/v1';
import { ClaimItemViewViewStatusEnum, ContentMetadataCreatorTypeEnum } from '@rbx/client-rights/v1';
            ...
            <Grid item XSmall={12}>
              <Link href={creatorURL} passHref legacyBehavior>
                <UILink color='inherit' target='_blank'>
                  {getPrefixedCreatorName(creatorType, creatorName)}
                </UILink>
              </Link>
            </Grid>
          )}
