...
import { SearchContentCreatorTypeEnum } from '@rbx/client-rights/v1';
...
import { getCreatorUrl } from '@modules/miscellaneous/urls/www';
...
function getContentCreatorLink(content: SearchContent) {
  if (!content.creator?.id || !content.creator.type) {
    return '';
  }
