 ...
 * When the range spans two calendar years, includes the year on both bounds (e.g. "Dec 31, 2026 - Jan 2, 2027").
 */
export const getDateRangeLabel = (
  ...
  const formatMonthDay = (d: Date) =>
    formatter.getCustomDateTime(d, { month: 'short', day: 'numeric' });
  const formatMonthDayYear = (d: Date) =>
    formatter.getCustomDateTime(d, { year: 'numeric', month: 'short', day: 'numeric' });
