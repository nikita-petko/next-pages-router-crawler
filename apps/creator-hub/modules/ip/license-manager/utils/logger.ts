...
export enum LicenseManagerClickEvent {
  ...
  PublicListingDetailsPageLicenseAccordionToggleClickEvent = 'publicListingDetailsPageLicenseAccordionToggleClickEvent',
  ...
  IphListingsDetailsPageDeselectAllShowcasedExperiencesClickEvent = 'iphListingsDetailsPageDeselectAllShowcasedExperiencesClickEvent',
  ...
  MatchDetailsPanelNavigationClickEvent = 'matchDetailsPanelNavigationClickEvent',
  MatchDetailsPanelViewCreationClickEvent = 'matchDetailsPanelViewCreationClickEvent',
  MatchDetailsPanelViewAgreementClickEvent = 'matchDetailsPanelViewAgreementClickEvent',
  MatchDetailsPanelViewDetailsClickEvent = 'matchDetailsPanelViewDetailsClickEvent',
  MatchDetailsPanelOfferLicenseClickEvent = 'matchDetailsPanelOfferLicenseClickEvent',
  MatchDetailsPanelDismissClickEvent = 'matchDetailsPanelDismissClickEvent',
  MatchOfferPanelCreateLicenseClickEvent = 'matchOfferPanelCreateLicenseClickEvent',
  MatchOfferPanelSubmitClickEvent = 'matchOfferPanelSubmitClickEvent',
  MatchOfferPanelFieldChangeClickEvent = 'matchOfferPanelFieldChangeClickEvent',
  IgnoreMatchPanelOpenClickEvent = 'ignoreMatchPanelOpenClickEvent',
  IgnoreMatchPanelSelectReasonClickEvent = 'ignoreMatchPanelSelectReasonClickEvent',
  IgnoreMatchPanelBackClickEvent = 'ignoreMatchPanelBackClickEvent',
...
export enum LicenseManagerImpressionEvent {
  ...
  MatchOfferPanelImpressionEvent = 'matchOfferPanelImpressionEvent',
  MatchOfferPanelLoadFailureImpressionEvent = 'matchOfferPanelLoadFailureImpressionEvent',
  MatchOfferPanelNoCompatibleLicensesImpressionEvent = 'matchOfferPanelNoCompatibleLicensesImpressionEvent',
  MatchOfferPanelModerationFailureImpressionEvent = 'matchOfferPanelModerationFailureImpressionEvent',
  IgnoreMatchPanelSuccessImpressionEvent = 'ignoreMatchPanelSuccessImpressionEvent',
  IgnoreMatchPanelFailureImpressionEvent = 'ignoreMatchPanelFailureImpressionEvent',
  PublicListingDetailsPageShowcasedExperiencesImpressionEvent = 'publicListingDetailsPageShowcasedExperiencesImpressionEvent',
  PublicListingDetailsPageShowcaseContentImpressionEvent = 'publicListingDetailsPageShowcaseContentImpressionEvent',
  ...
  PublicListingDetailsPageLicenseImpressionEvent = 'publicListingDetailsPageLicenseImpressionEvent',
  ...
  IphListingsDetailsPageScrollableShowcasedExperiencesImpressionEvent = 'iphListingsDetailsPageScrollableShowcasedExperiencesImpressionEvent',
  IphListingsDetailsPageSaveShowcasedExperiencesSuccessImpressionEvent = 'iphListingsDetailsPageSaveShowcasedExperiencesSuccessImpressionEvent',
  IphListingsDetailsPageSaveShowcasedExperiencesFailureImpressionEvent = 'iphListingsDetailsPageSaveShowcasedExperiencesFailureImpressionEvent',
  IphListingsDetailsPageConfirmedIneligibleShowcasedExperiencesAlertImpressionEvent = 'iphListingsDetailsPageConfirmedIneligibleShowcasedExperiencesAlertImpressionEvent',
  IphListingsDetailsPageIndeterminateShowcasedExperiencesAlertImpressionEvent = 'iphListingsDetailsPageIndeterminateShowcasedExperiencesAlertImpressionEvent',
  IphListingsDetailsPageMissingShowcaseETagImpressionEvent = 'iphListingsDetailsPageMissingShowcaseETagImpressionEvent',
  IphListingsDetailsPageShowcaseConflictRecoveryImpressionEvent = 'iphListingsDetailsPageShowcaseConflictRecoveryImpressionEvent',
  ...
  EmptyStatePublicLicensesTableNoMatchesWithAppliedFiltersImpressionEvent = 'emptyStatePublicLicensesTableNoMatchesWithAppliedFiltersImpressionEvent',
