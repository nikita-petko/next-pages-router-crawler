...
const useConfirmation = () => {
  ...
  const confirmationContent: ReactNode | null = confirmationState ? (
    <Dialog open={confirmationState.isOpen} onClose={() => handleClose(false)}>
      <DialogTitle>{confirmationState.title}</DialogTitle>
      <DialogContent>
        <DialogContentText>{confirmationState.description}</DialogContentText>
      </DialogContent>
      {confirmationState.extraContent}
