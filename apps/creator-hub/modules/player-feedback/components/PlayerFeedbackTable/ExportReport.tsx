...
import { ReviewCategoryType } from '@rbx/clients/playerGeneratedReviewsService';
  ...
  const onClick = useCallback(async () => {
    ...
    try {
      ...
      const fileBlob = await downloadAssetReviews({
        ...
        // Cast to generated client enum to avoid literal drift
        categoryType:
          categoryType === CategoryType.All
            ? undefined
            : (categoryType as unknown as ReviewCategoryType),
        hasComment: commentsOnly,
