...
import { GamePassConfigV2 } from '@modules/clients/passes';
import { ListDeveloperProductsConfigsResponse } from '@modules/developer-products/queries/useInfiniteListDeveloperProducts';
import { INITIAL_FETCH_TOTAL } from '../../manage-items/hooks/constants';
import {
...
function useProductCountSummary(universeId: number, initialTotal: number = INITIAL_FETCH_TOTAL) {
...
export default useProductCountSummary;
