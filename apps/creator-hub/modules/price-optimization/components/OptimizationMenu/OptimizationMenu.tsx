// oxlint-disable typescript/no-non-null-assertion  react/react-compiler-- revisit
...
import type { TDialogContext } from '@rbx/ui';
import {
  Button,
  DialogActions,
  DialogContent,
...
type TTranslationProps = Pick<UseTranslationResult, 'translate' | 'translateHTML'>;
