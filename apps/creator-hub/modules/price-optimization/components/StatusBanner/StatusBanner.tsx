import { Alert, AlertTitle, CloseIcon, IconButton, Link, TAlertProps } from '@rbx/ui';
...
const StatusBanner = () => {
  ...
  // eslint-disable-next-line default-case -- Default is to keep heading and message as empty string
