...
- Have a clear, novel game concept that feels fresh and can invite more 18+ players to Roblox—new genres, new gameplay patterns, or a distinctive look and feel.
...
const allPrograms: Program[] = [
  {
    ...
    applyUrl: 'https://survey.roblox.com/jfe/form/SV_a5fvz9Y4204yfMa',
    contents: [
      {
...
export default function Programs() {
  return (
    <Section
      ...
      title='Programs'
      subtitle='Introducing two new programs to help you pioneer the next generation of novel games on Roblox and invite more 18+ players to Roblox. For more on novel games, see below.'
