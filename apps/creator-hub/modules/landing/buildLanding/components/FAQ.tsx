...
const allQA: QA[] = [
  {
    ...
    answer: (
      <React.Fragment>
        <span>
          {`Genre, gameplay, and visual style are common factors in a player's decision to try a new experience. Entrance into Roblox Incubator and Jumpstart hinge on innovation in these areas.`}
        </span>
        <ul
