import { developClient, groupsClient, usersClient } from '@modules/clients';
...
import { PrivateAssetTypes, TAssetDetails } from './types';
...
const getAssetDetails = async (
  ...
  assetIds.forEach((id) => {
    if (!resultMap.has(id) && !invalidAssetTypeIdsSet.has(id)) {
      missingAssetDetailsMap.set(id as number, {
        assetId: id,
        name: '',
        assetType: null,
        creatorName: '',
