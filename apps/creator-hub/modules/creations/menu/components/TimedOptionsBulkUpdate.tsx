...
import type { TimedOptionsAllBulkUpdateAssetTypesByCategory } from './TimedOptionsAllBulkUpdate';
import TimedOptionsAllBulkUpdate from './TimedOptionsAllBulkUpdate';
    ...
    showAllTimedOptions
      ? (() => {
          ...
          const useFilteredOriginalClothing =
            !categoryFlags.showCategorySubtypeDropdowns ||
          ...
          const accessories = !categoryFlags.showCategorySubtypeDropdowns
            ? []
