...
import { FailureReason, Money } from '@rbx/clients/developerSubscriptionsApi';
import {
...
function ConfigureExperienceSubscriptionForm({
  ...
  // ! level typing fixes
  // eslint-disable-next-line @typescript-eslint/ban-ts-comment -- @ts-ignore known issue with `react-hook-form`'s typing
        ...
        <Grid
                  ...
                  helperText={
                    canUpdateDescription && (
                      <ExperienceSubscriptionLimitErrorMessage
                        error={errors.description}
                        /* eslint-disable-next-line  -- NOTE (jcountryman, 6/10/24): Turned off to check in text field consolidation work. Codeowners is
          ...
          <Grid item XSmall={12}>
            <Controller
              ...
              render={({ field }) => (
                <Select
                  /* eslint-disable-next-line @typescript-eslint/ban-ts-comment -- NOTE (jcountryman, 6/10/24): Turned off to check in text field consolidation work. Codeowners is
                   * responsible for triaging issue.
                   */
                  {...field}
                  fullWidth
