import { DeveloperSubscriptionProductType } from '@rbx/client-developer-subscriptions-api/v1';
...
export const CreateSubscriptionProductTypeByFormValue: Record<
  string,
  DeveloperSubscriptionProductType
> = {
  [ProductTypes.Consumable]: DeveloperSubscriptionProductType.Consumable,
  [ProductTypes.Currency]: DeveloperSubscriptionProductType.Currency,
  [ProductTypes.Durable]: DeveloperSubscriptionProductType.Durable,
};
