import React, { Fragment, FunctionComponent, useCallback, useState, useEffect } from 'react';
import { ownershipTransferClient, User, TransferHold } from '@modules/clients';
...
import { ResourceType, HoldState } from '@rbx/clients/ownershipTransferApi';
  ...
  useEffect(() => {
    if (latestTransferDetails !== undefined) {
      if (latestTransferDetails === null) {
        ...
        latestTransferDetails?.expirationAcknowledged === false
      ) {
