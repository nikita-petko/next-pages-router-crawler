...
import { developClient, User, groupsClient, usersClient } from '@modules/clients';
...
import { Privacy, UniverseConfiguration } from '../ConfigureExperienceTypes';

const ConfigureExperienceContainer: FunctionComponent<React.PropsWithChildren<unknown>> = () => {
  const {
    params: { enableExperienceReleases },
    isFetched: isCreatorDashboardIxpFetched,
        ...
        if (
          ...
          setIsPublicConnectionsDisabled(
            (developResponseV2?.isForSale ?? false) ||
              ...
              (developResponseV2?.allowPrivateServers ?? false),
          );
  ...
  return (
    <ConfigureExperienceForm
      ...
      enableExperienceReleases={Boolean(enableExperienceReleases)}
