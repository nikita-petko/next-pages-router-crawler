...
import useUniverseID from '@modules/experience-analytics-shared/context/useUniverseID';
...
const NotificationsAnalyticsProvider: FunctionComponent<React.PropsWithChildren> = ({
  children,
}) => {
  ...
  const initializeNotificationsContentAnalytics = useCallback(
    async (startDate: Date, endDate: Date) => {
      if (!universeId || isNotificationAnalyticsLoading) {
        return;
      }
