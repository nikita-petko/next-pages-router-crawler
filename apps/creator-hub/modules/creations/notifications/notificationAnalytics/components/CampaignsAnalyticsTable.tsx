import { ChartHeader, GenericChartWrapper } from '@modules/charts-generic';
import { useTranslationWrapper, translationKey } from '@modules/analytics-translations';
import { HorizontalScrollWrapper } from '@modules/experience-analytics-shared';
...
import { NotificationsContentCampaignAnalyticsTableRow } from '../../types/notificationAnalytics';
...
const CampaignsAnalyticsTableTitle: React.FC<React.PropsWithChildren<unknown>> = () => {
...
const CampaignsAnalyticsTableHeader: React.FC<React.PropsWithChildren<unknown>> = () => {
  const {
