...
import { CreationData, ItemGridContainer } from '@modules/creations/common';
import { PageResponse, PagingParameters, SortOrder } from '@rbx/core';
import universesClient, { PlacesItems } from '@modules/clients/universes';
  ...
  const loadPlacesByContext = useCallback(
    async (
      ...
      if (enableGetOwnedPlacesByContextV2) {
        ...
        const placesDataSinglePage = placesData.places as PlacesItems[];
