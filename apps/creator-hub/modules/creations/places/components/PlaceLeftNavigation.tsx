...
import { Item, itemTypeToSingularNameKeys, Link } from '@modules/miscellaneous/common';
...
import placeFeatureManager, {
  PlaceFeatureSettings,
  PlaceLeftNavigationSectionTitleKeys,
} from './placeFeatureManager';
import PlaceStatus from './PlaceStatus';

const PlaceLeftNavigation: FunctionComponent<React.PropsWithChildren<unknown>> = () => {
