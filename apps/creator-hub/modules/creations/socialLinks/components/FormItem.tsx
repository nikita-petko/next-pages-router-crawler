...
import { Controller, FieldPath, useFormContext, useWatch, ErrorOption } from 'react-hook-form';
import { SocialLinksMetadata, SocialLinkTypes } from '@modules/clients';
            ...
            rules={{
              ...
              validate: {
                linkTypeMatch: (value) => {
                  ...
                  const err = validateLink(value as SocialLinkTypes, url as string);
                  if (err !== null) {
                    setError(urlKey, err);
                  } else {
                    clearErrors(urlKey);
