...
import { AllSettlePromiseFailed, FormMode, urls } from '@modules/miscellaneous/common';
...
import { assetPermissionsApiClient, developClient, tryParseResponseError } from '@modules/clients';
import {
...
import { GearGenresAllowPolicy, InGamePermissionType, PlacePermissionsFormType } from './types';
import { PlacePermissionConfiguration } from '../PlacePermissionsContainer/PlacePermissionsContainer';
...
> = ({ placePermissionsValues, refreshData }) => {
  ...
  const handleCopyLockOnchange = useCallback(
    (e: React.ChangeEvent<HTMLInputElement>, fieldOnChange: ControllerRenderProps['onChange']) => {
      const isCopyAllowed = e.target.checked as boolean;
...
Codeowners is responsible for triaging issue. */
