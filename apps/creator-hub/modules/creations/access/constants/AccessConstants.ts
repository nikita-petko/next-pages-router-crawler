import { RobloxApiDevelopModelsUniverseSettingsResponsePlayableDevicesEnum } from '@rbx/client-develop/v1';
...
export const PrivateServerRegionalPricingMinPrice = 10;
export const PrivateServerMaxPrice = 500;
export const PrivateServerPriceChangeCooldownDays = 60;

// Hours a creator must wait before re-enabling Robux paid access after turning it off.
export const PaidAccessReactivationCooldownHours = 24;
...
export const accessTypeTranslationKeys: { [key in AccessType]: string } = {
  [AccessType.Friends]: 'Label.AccessType.FriendsTitle',
...
export const devicesTypeTranslationKeys: {
  ...
  [RobloxApiDevelopModelsUniverseSettingsResponsePlayableDevicesEnum.Tv]: 'Label.DeviceType.TV',
};

export const ageRestrictionTypeTranslationKeys: { [key in AgeRestrictionType]: string } = {
  [AgeRestrictionType.AllAges]: 'Label.AllAges',
  [AgeRestrictionType.NinePlus]: 'Label.AgePlus',
  [AgeRestrictionType.ThirteenPlus]: 'Label.AgePlus',
  [AgeRestrictionType.EighteenPlus]: 'Label.AgePlus',
};
