...
import { ConfirmDialog, CreatorType, Item, urls } from '@modules/miscellaneous/common';
import { badgesClient, economyClient, GetBadgesMetadataResponse } from '@modules/clients';
...
import {
  CreateBadgeFormDefaultValue,
  CreateBadgeFormType,
  CreateBadgeRegisterOptions,
} from './types';
...
const CreateBadgeForm: FunctionComponent<React.PropsWithChildren<CreateBadgeFormProps>> = ({
  ...
  const handleFormCancel = useCallback(() => {
    /* eslint-disable-next-line @typescript-eslint/no-unused-vars -- NOTE (jcountryman, 6/10/24): Turned off to check in text field consolidation work. Codeowners is
     * responsible for triaging issue.
     */
    const { id: _, ...routerQueryWithoutId } = router.query;
    router.push({
