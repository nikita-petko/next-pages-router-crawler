...
import type { GetBadgeByIdResponse, GetBadgesMetadataResponse } from '@modules/clients/badges';
...
import type { ConfigureBadgeFormType } from './types';
import { ConfigureBadgeRegisterOptions } from './types';
