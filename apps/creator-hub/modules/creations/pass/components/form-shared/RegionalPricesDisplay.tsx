...
import type { ConfigureSalesFormValues } from './types';

type Props = {
  universeId: number;
  control: Control<ConfigureSalesFormValues>;
  /** Whether to unmount the component when the regional pricing is disabled @default true*/
  ...
  return (
    <>
      <TopCountriesTable
        ...
        className={clsx(isDimmed && 'opacity-[0.5]', className)}
      />
      <AllCountriesModal
