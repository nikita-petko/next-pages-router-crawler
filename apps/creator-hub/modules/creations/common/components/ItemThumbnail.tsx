...
import { RobloxThumbnailsApisModelsThumbnailBatchRequestTypeEnum } from '@rbx/client-thumbnails/v1';
import type { ThumbnailTypes, ReturnPolicy } from '@rbx/thumbnails';
