import type { EventMedia, EventRankedCategory } from '@rbx/client-virtual-events-api/v1';
...
import type { EventThumbnail } from '../components/CreateEventForm/types';
...
export const isPastEvent = (eventItem: CreationData): boolean => {
  return (
    ...
    (eventItem.endTime && eventItem.endTime.getTime() < Date.now()) ||
    false
  );
};
