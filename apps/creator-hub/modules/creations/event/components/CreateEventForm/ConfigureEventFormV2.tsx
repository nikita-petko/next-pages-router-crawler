...
import { EventStatus, EventVisibility, FeaturingStatus } from '@rbx/client-virtual-events-api/v1';
...
import type { CreateEventFormType, EventThumbnail } from './types';
import { CreateEventFormDefaultValues } from './types';
...
const ConfigureEventFormV2: FunctionComponent<PropsWithChildren<ConfigureEventFormProps>> = ({
  universeId,
  initialEventDetails,
  onSaveOrPublish,
  correlationId,
