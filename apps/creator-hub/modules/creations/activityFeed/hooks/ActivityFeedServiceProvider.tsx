...
import { ActivityFeedServiceResponse, ActivityFeedEvent } from './useActivityFeedItemInfo';

// TODO: @jchong - ARKS-2006 - Migrate from this file to a proper grasshopper client.
const ActivityFeedServiceProvider: FunctionComponent<React.PropsWithChildren<unknown>> = ({
  children,
}) => {
  ...
  const fetchServiceResponses = useCallback(async (universeId: number) => {
    try {
      ...
      // eslint-disable-next-line no-console -- we'd like to keep this error
