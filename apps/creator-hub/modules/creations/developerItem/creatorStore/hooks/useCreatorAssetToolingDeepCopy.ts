...
import type { GetDeepCopyOperationStatusResponse } from '@rbx/client-creator-asset-tooling-api/v1';
import { OperationStatus, ErrorCode } from '@rbx/client-creator-asset-tooling-api/v1';
