      ...
      <DialogTitle>
        <Grid container gap={1} classes={{ root: titleContainer }}>
          ...
          <Typography color='secondary' variant='body1'>
            {translate('Description.AddCollaborators')}
          </Typography>
        </Grid>
      </DialogTitle>
      <DialogContent>
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField
              ...
              label={params.inputProps.value ? translate('Label.SearchFriendsAndGroups') : ''}
              placeholder={translate('Label.SearchFriendsAndGroups')}
            />
          )}
