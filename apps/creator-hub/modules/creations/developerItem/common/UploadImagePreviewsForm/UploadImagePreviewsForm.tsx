...
import { HttpStatusCodes, ImageUploader, EntityType } from '@modules/miscellaneous/common';
...
} from '@modules/creations/placeThumbnails';
    ...
    setReorderedList((prevListOrder) => {
      ...
      if (imagePreviewIds.length > prevListOrder.length) {
        ...
        imagePreviewIds.forEach((id, index) => {
          if (newListOrder.find((innerItem) => innerItem === id) === undefined) {
