...
import { OneTimePayoutBase, OneTimePayoutBaseV2 } from '../interface/OneTimePayoutFormType';
import { PayoutMetadata } from '../hooks/useUserOptionsForGroupMembersEligibleForPayout';

export function isPayoutMetadata(metadata: unknown | undefined): metadata is PayoutMetadata {
...
export const truncateString = (str: string) => {
  return str.length > chartLabelMaxLength
    ? `${str.substring(0, chartLabelMaxLength).trim()}...`
    : str;
};
