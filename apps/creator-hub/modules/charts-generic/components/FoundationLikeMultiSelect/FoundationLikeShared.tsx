...
// ---------------------------------------------------------------------------
// TForwardRefComponent – restores prop constraints lost by forwardRef
// ---------------------------------------------------------------------------
...
export type TForwardRefComponent<TBase extends object> = (<T extends ElementType>(
  props: TBase & { ref?: ComponentProps<T>['ref'] },
...
export const CHEVRON_SIZE_CLASS_BY_SIZE: Record<TDropdownSize, TTailwindSizeClass> = {
  XSmall: 'size-300',
  Small: 'size-400',
  Medium: 'size-500',
  Large: 'size-600',
