...
import { GetCreatorMetadataResponse, Requirements } from '@rbx/clients/affiliateLinksApi';
import {
...
const AffiliateProgramProvider: FunctionComponent<React.PropsWithChildren<unknown>> = ({
  children,
}) => {
