...
const recommendedEventsJourneysFilterDimensions: ReadonlyArray<TRAQIV2Dimension> = [
  RAQIV2Dimension.JourneyName,
  RAQIV2Dimension.JourneyVersion,
...
export default recommendedEventsJourneysFilterDimensions;
