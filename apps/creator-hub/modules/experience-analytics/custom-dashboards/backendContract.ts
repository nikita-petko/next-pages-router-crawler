...
const CHART_TYPE_TO_PROTO: Record<CustomDashboardChartType, ApiDashboardChartType> = {
  [ChartType.Spline]: 1,
  [ChartType.Area]: 2,
  [ChartType.DurationSpline]: 7,
  [ChartType.DurationArea]: 8,
  [ChartType.Bar]: 3,
  [ChartType.Column]: 4,
  [ChartType.Pie]: 5,
  [ChartType.Table]: 6,
...
const PROTO_TO_CHART_TYPE: Record<string, CustomDashboardChartType> = {
  ...
  DASHBOARD_CHART_TYPE_DURATION_SPLINE: ChartType.DurationSpline,
  DASHBOARD_CHART_TYPE_DURATION_AREA: ChartType.DurationArea,
  ...
  '1': ChartType.Spline,
  '2': ChartType.Area,
  '7': ChartType.DurationSpline,
  '8': ChartType.DurationArea,
  '3': ChartType.Bar,
  '4': ChartType.Column,
  '5': ChartType.Pie,
  '6': ChartType.Table,
