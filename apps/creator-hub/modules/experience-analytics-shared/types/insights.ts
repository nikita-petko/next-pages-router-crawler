...
import type { AchievementChartKeys } from './achievements';
import type { TChartEventLogging } from './ChartEventLogger';
import { ChartLoggingContext } from './ChartEventLogger';
...
export const getInsightCardCaptions = (
  ...
  switch (type) {
    ...
    default: {
      ...
      throw new Error(`Unhandled Insight type ${String(exhaustiveCheck)}`);
    }
  }
};
