...
import { AnalyticsBenchmarkQuery, AnalyticsBenchmarkType } from '@modules/clients/analytics';
import {
  RAQIV2AbuseChannel,
...
import { TRAQIV2NumericUIMetric } from '..';
...
export const useAnalyticsBenchmarks = (
  ...
  const analyticsBenchmarkRequest: AnalyticsBenchmarkQuery | null = useMemo(() => {
    ...
    // Unfortunate hack to disable benchmarks for Creator Rewards until the feature is fully released,
    // since the feature flag needs to be in the hook part of the component.
    if (
    ...
    return query;
  }, [spec, isCreatorRewardsBenchmarksEnabled, isFetched, apiBenchmarkType]);
