import type { FeatureAttributes } from '@rbx/client-universe-analytics-insights/v1';
import {
  RAQIV2DateRangeType,
  RAQIV2MemoryGroup,
  RAQIV2OperatingSystem,
...
const updateThumbnailsRFYPTR = translationKey(
  'Description.Recommendation.UpdateThumbnailsRFYPTR',
  TranslationNamespace.Insights,
);
...
const managedPricingRecommendation = translationKey(
  'Description.Recommendation.ManagedPricing',
  TranslationNamespace.AnalyticsAssistant,
);
const experimentationFunnelsRecommendation = translationKey(
  'Description.Recommendation.ExperimentationFunnels',
  TranslationNamespace.AnalyticsAssistant,
);
...
export enum LowestBenchmarkRecommendationType {
  ...
  LowestBenchmarkRFYPTR = 'LowestBenchmarkRFYPTR',
...
const recommendationTypeToInsightsLinkSpec = (
  ...
  switch (type) {
    ...
    case LowestBenchmarkRecommendationType.LowestBenchmarkRFYPTR:
      return [
        { linkSetType: LinkSetType.Thumbnails, translationKey: updateThumbnailsRFYPTR },
        {
          linkSetType: LinkSetType.AcquisitionRFYAndDiscovery,
          translationKey: viewRFYSignalsAndLearnDiscovery,
        },
    ...
    case RecommendationType.ProductManagedPricing: {
      return [
        {
          linkSetType: LinkSetType.ManagedPricing,
          translationKey: managedPricingRecommendation,
        },
      ];
    }
    case RecommendationType.ProductExperimentationFunnels:
      return [
        {
          linkSetType: LinkSetType.Experimentation,
          translationKey: experimentationFunnelsRecommendation,
        },
      ];
...
const linkSetTypeToLinks = (
  ...
  switch (linkSetType) {
    case LinkSetType.Funnel:
      return [{ url: creatorHub.dashboard.getAnalyticsFunnelsUrl(universeId), type: 'dashboard' }];
    case LinkSetType.RetentionD1:
      return [{ url: creatorHub.docs.getAnalyticsRetentionGuideUrl(), type: 'docs' }];
    case LinkSetType.Engagement:
      return [{ url: creatorHub.docs.getAnalyticsEngagementGuideUrl(), type: 'docs' }];
    case LinkSetType.RetentionD7:
      return [{ url: creatorHub.docs.getAnalyticsRetentionD7GuideUrl(), type: 'docs' }];
    case LinkSetType.RetentionD30:
      return [{ url: creatorHub.docs.getAnalyticsRetentionD30GuideUrl(), type: 'docs' }];
    case LinkSetType.DevProductsPassAndEconomy:
      return [
        {
          url: creatorHub.dashboard.getMonetizationDeveloperProductsAnalyticsTabUrl(universeId),
          type: 'dashboard',
        },
        {
          url: creatorHub.dashboard.getMonetizationPassesAnalyticsTabUrl(universeId),
          type: 'dashboard',
        },
        { url: creatorHub.dashboard.getAnalyticsEconomyUrl(universeId), type: 'dashboard' },
      ];
    case LinkSetType.PayerConversion:
      return [
        {
          url: creatorHub.docs.getAnalyticsMonetizationPayerConversionRateGuideUrl(),
          type: 'docs',
        },
      ];
    case LinkSetType.RevenuePerUser:
      return [{ url: creatorHub.docs.getAnalyticsMonetizationARPPUGuideUrl(), type: 'docs' }];
    case LinkSetType.Thumbnails:
      return [
        {
          url: creatorHub.dashboard.getPlaceThumbnailsUrl(universeId, placeId),
          type: 'dashboard',
        },
      ];
    case LinkSetType.Discovery:
      return [{ url: creatorHub.docs.getDiscoveryUrl(), type: 'docs' }];
    case LinkSetType.Acquisition:
      return [
        { url: creatorHub.dashboard.getAnalyticAcquisitionUrl(universeId), type: 'dashboard' },
      ];
    case LinkSetType.AcquisitionNewUserFunnel:
      return [
        {
          url: `${creatorHub.dashboard.getAnalyticAcquisitionUrl(universeId)}#new-user-funnel`,
          type: 'dashboard',
        },
      ];
    case LinkSetType.AcquisitionRFY:
      return [
        {
          url: creatorHub.dashboard.getAnalyticAcquisitionHomeRecommendationsUrl(universeId),
          type: 'dashboard',
        },
      ];
    case LinkSetType.AcquisitionAndDiscovery:
      return [
        { url: creatorHub.dashboard.getAnalyticAcquisitionUrl(universeId), type: 'dashboard' },
        { url: creatorHub.docs.getDiscoveryUrl(), type: 'docs' },
      ];
    ...
    case LinkSetType.Economy:
      return [{ url: creatorHub.dashboard.getAnalyticsEconomyUrl(universeId), type: 'dashboard' }];
      ...
      return [
        {
          url: buildExperienceAnalyticsUrlWithParams(
            ...
            {
              [AnalyticsQueryParams.RangeType]: RAQIV2DateRangeType.Last7Days,
    ...
    case LinkSetType.Streaming:
      return [
        {
          url: creatorHub.docs.getStreamingUrl(),
          type: 'docs',
        },
      ];
    case LinkSetType.Localization:
      return [{ url: creatorHub.dashboard.getLocalizationUrl(universeId), type: 'dashboard' }];
    case LinkSetType.GameDesignMissions:
      return [{ url: creatorHub.docs.getGameDesignMissionsUrl(), type: 'docs' }];
    case LinkSetType.GameDesignStarterPack:
      return [{ url: creatorHub.docs.getGameDesignStarterPackUrl(), type: 'docs' }];
    case LinkSetType.GameDesignBundles:
      return [{ url: creatorHub.docs.getGameDesignBundlesUrl(), type: 'docs' }];
    case LinkSetType.GameDesignSeasonPass:
      return [{ url: creatorHub.docs.getGameDesignSeasonPassUrl(), type: 'docs' }];
    case LinkSetType.GameDesignEngagementRewards:
      return [{ url: creatorHub.docs.getGameDesignEngagementRewardsUrl(), type: 'docs' }];
    case LinkSetType.Passes:
      return [
        {
          url: creatorHub.dashboard.getMonetizationPassesUrl(universeId),
          type: 'dashboard',
        },
      ];
    case LinkSetType.DeveloperProducts:
      return [
        {
          url: creatorHub.dashboard.getMonetizationDeveloperProductsUrl(universeId),
          type: 'dashboard',
        },
      ];
    case LinkSetType.PriceOptimization:
      return [
        {
          url: creatorHub.dashboard.getMonetizationPriceOptimizationUrl(universeId),
          type: 'dashboard',
        },
      ];
    case LinkSetType.ManagedPricing:
      return [
        {
          url: creatorHub.dashboard.getManagedPricingUrl(universeId),
          type: 'dashboard',
        },
      ];
    case LinkSetType.Experimentation:
      return [
        {
          url: creatorHub.dashboard.getExperimentsUrl(universeId),
          type: 'dashboard',
        },
      ];
    case LinkSetType.AdsManager:
      return [
        {
          url: www.getSponsorExperienceUrl(universeId),
          type: 'dashboard',
        },
      ];
    case LinkSetType.ProductIntelligenceApis:
      return [
        {
          url: creatorHub.docs.getProductIntelligenceApisUrl(),
          type: 'docs',
        },
      ];
