...
const useScoreCardSuggestions = ({
  ...
  const recommendation = useMemo(() => {
    // oxlint-disable-next-line typescript/switch-exhaustiveness-check -- intentional default throw for unsupported scorecard metrics
    switch (metric) {
      ...
      case RAQIV2Metric.RFYPlayThroughRate:
      case RAQIV2Metric.L7AverageRFYPlayThroughRate:
        return LowestBenchmarkRecommendationType.LowestBenchmarkRFYPTR;
