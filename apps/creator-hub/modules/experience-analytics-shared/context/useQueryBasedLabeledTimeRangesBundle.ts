...
import { LabeledDateRange } from '../components/RAQIV2/GenericRAQIV2TabbedTimeComparatorCharts';
...
const useQueryBasedLabeledTimeRangesBundle = (): AnalyticsLabeledDateRangesBundle => {
  ...
  const parseTimeRangeQueryString = (queryToParse: string | string[] | null | undefined) => {
    ...
    const queryArray = queryToParse instanceof Array ? queryToParse : [queryToParse];
