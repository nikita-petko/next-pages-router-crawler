...
import type { RecommendedEventsLiveStatsClientWrapper } from '@modules/clients/analytics';
import { recommendedEventsLiveStatsClient } from '@modules/clients/analytics';
