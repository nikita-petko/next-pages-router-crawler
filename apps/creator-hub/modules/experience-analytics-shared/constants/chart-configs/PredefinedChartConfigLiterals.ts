...
export const chartConfigPerformanceServerCpuCoreUtilization = {
  type: AnalyticsComponentType.Chart,
  titleKey: translationKey('Title.ServerCpuCoreUtilization', TranslationNamespace.Analytics),
  definitionTooltipKey: translationKey(
    'Description.CpuCoreUtilization',
    TranslationNamespace.Analytics,
  ),
  metric: RAQIV2Metric.CpuCoreUtilization,
  overrides: {},
  chartType: ChartType.Spline,
  overlays: [],
  summarySpec: {
...
export const chartConfigFunnelCohortCompletionRate = {
  type: AnalyticsComponentType.Chart,
  chartKey: RAQIV2PredefinedChartKey.FunnelCohortCompletionRate,
  titleKey: translationKey('Title.FunnelCompletionByCohort', TranslationNamespace.Analytics),
  definitionTooltipKey: translationKey(
    'Description.FunnelCompletionByCohort',
    TranslationNamespace.Analytics,
  ),
  metric: RAQIV2Metric.FunnelCohortCompletionRate,
  overrides: {
    breakdown: {
    ...
    perBreakdownSummaryTypes: [
      {
        type: RAQIV2SummaryType.Average,
        specificLabel: {
          translationKey: translationKey('Label.Average', TranslationNamespace.Analytics),
        },
      },
    ],
    aggregatedBreakdownSummaryTypes: [],
...
export const chartConfigFunnelCohortSessionCompletionRate = {
  type: AnalyticsComponentType.Chart,
  chartKey: RAQIV2PredefinedChartKey.FunnelCohortSessionCompletionRate,
  titleKey: translationKey('Title.FunnelCompletionByCohort', TranslationNamespace.Analytics),
  definitionTooltipKey: translationKey(
    'Description.FunnelCohortSessionCompletionRate',
    TranslationNamespace.Analytics,
  ),
  metric: RAQIV2Metric.FunnelCohortSessionCompletionRate,
  overrides: {
    breakdown: {
      override: [RAQIV2Dimension.FunnelStep],
    },
...
const rfyPlayThroughRateTitleKey = translationKey(
  'Label.Metric.RFYPlayThroughRate',
  TranslationNamespace.Analytics,
);
const rfyPlayThroughRateDescriptionKey = translationKey(
  'Description.RFYPlayThroughRate',
  TranslationNamespace.Analytics,
);
export const chartConfigRFYPlayThroughRate = {
  type: AnalyticsComponentType.Chart,
  chartKey: RAQIV2PredefinedChartKey.RFYPlayThroughRate,
  titleKey: rfyPlayThroughRateTitleKey,
  definitionTooltipKey: rfyPlayThroughRateDescriptionKey,
...
export const chartConfigL7AverageRFYPTR = {
  type: AnalyticsComponentType.Chart,
  titleKey: translationKey(
    'Label.Metric.L7AverageRFYPlayThroughRate',
    TranslationNamespace.Analytics,
  ),
  definitionTooltipKey: translationKey(
