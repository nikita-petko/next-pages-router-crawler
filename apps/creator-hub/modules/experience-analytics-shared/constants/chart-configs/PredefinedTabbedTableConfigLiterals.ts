import { translationKey, translationKeyWithoutNamespace } from '@modules/analytics-translations';
import { TranslationNamespace } from '@modules/miscellaneous/localization';
import AnalyticsComponentType from '@modules/analytics-configurations/AnalyticsComponentType';
import { AnalyticsTabbedTableConfig } from '../RAQIV2PredefinedTabbedTableConfigs';
import {
...
export const tabbedTableConfigNewUsersFunnelV2 = {
  ...
  tabs: [
    {
      ...
      config: tableConfigNewUsersFunnelOverviewV2,
    ...
    },
    {
      ...
      config: tableConfigNewUsersFunnelAcquisitionV2,
