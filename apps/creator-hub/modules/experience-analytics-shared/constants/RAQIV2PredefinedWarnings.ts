...
export enum RAQIV2PredefinedWarnings {
  ...
  RfyFirstPlayBounceRate = 'RfyFirstPlayBounceRate',
  ServerCpuCoreUtilizationRecommendation = 'ServerCpuCoreUtilizationRecommendation',
}
...
export const RAQIV2MetricWarningsConfig: Map<TRAQIV2UIMetric, TRAQIV2PredefinedWarning[]> = new Map(
  [
    ...
    [
      RAQIV2Metric.AdsPublisherReportingVideo2DReachRatio,
      [
        {
          type: RAQIV2PredefinedWarningCondition.Always,
          warning: RAQIV2PredefinedWarnings.ImmersiveAdsExcludesUnvalidatedData,
    ...
    [
      RAQIV2Metric.AdsPublisherReportingVideo2DAdsPerDUV,
      [
        {
          type: RAQIV2PredefinedWarningCondition.Always,
          warning: RAQIV2PredefinedWarnings.ImmersiveAdsExcludesUnvalidatedData,
    ...
    [
      RAQIV2Metric.RFYDuration0To60,
      [
        {
          type: RAQIV2PredefinedWarningCondition.Always,
          warning: RAQIV2PredefinedWarnings.RfyFirstPlayBounceRate,
        },
      ],
    ],
    [
      RAQIV2Metric.RFYDuration61To180,
      [
        {
          type: RAQIV2PredefinedWarningCondition.Always,
          warning: RAQIV2PredefinedWarnings.RfyFirstPlayBounceRate,
    ...
    [
      ...
      [
        {
          type: RAQIV2PredefinedWarningCondition.Always,
          warning: RAQIV2PredefinedWarnings.ServerCpuCoreUtilizationRecommendation,
        },
      ],
    ],
  ],
...
> = {
  ...
  [RAQIV2PredefinedWarnings.RfyFirstPlayBounceRate]: translationKey(
    'Warning.RFYFirstPlayBounceRate',
    TranslationNamespace.Analytics,
  ),
  [RAQIV2PredefinedWarnings.ServerCpuCoreUtilizationRecommendation]: translationKey(
    'Warning.ServerCpuCoreUtilizationRecommendation',
    TranslationNamespace.Analytics,
  ),
};
