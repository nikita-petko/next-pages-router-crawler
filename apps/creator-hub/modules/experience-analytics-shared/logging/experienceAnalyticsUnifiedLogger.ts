import { DateRangeType, SingleDateType } from '@modules/charts-generic';
import { UnifiedLogger } from '@rbx/unified-logger';
import { LoggingTarget } from './LoggingTarget';
import loggingTargetToParameter from './loggingTargetToParameter';
import { AnalyticsHomeLoggingTarget } from './AnalyticsHomeLoggingTarget';
...
export const logRangeTypeChange = (
  client: UnifiedLogger,
  {
    ...
    oldRangeType,
    newRangeType,
  }: { loggingTarget?: LoggingTarget; oldRangeType: DateRangeType; newRangeType: DateRangeType },
) => {
