...
import { buildChartUnitOptions } from '@modules/experience-analytics-shared/adapters/genericRAQIV2ChartAdapter';
import genericRAQIV2DurationChartAdapter from '@modules/experience-analytics-shared/adapters/genericRAQIV2DurationChartAdapter';
...
import useMetricAwareYAxisFormatterEnabled from '@modules/experience-analytics-shared/hooks/useMetricAwareYAxisFormatterEnabled';
...
const generatePowerCurveData = (
  ...
  for (let day = startDay; day <= endDay; day += 1) {
    if (day > 0) {
      ...
      // Duration chart buckets are day numbers; this loop bounds the generated values to positive days.
