...
} from '@modules/experience-analytics-shared/adapters/analyticsAssistantAdapters';
...
import { isSummaryReportSignalMetric } from '../types/AssistantUISignal';
import type { ValidatedSignal } from '../validation/makeValidatedInsightsV2API';
import { toValidatedSignal, toValidatedInsight } from '../validation/makeValidatedInsightsV2API';
