...
import type { ItemMonetizationProductTypes } from '@modules/clients/analytics';
...
import type { ChartConfigWithPredefinedKey } from '@modules/experience-analytics-shared/constants/RAQIV2PredefinedChartConfig';
...
> = {
  ...
  [RAQIV2RevenueSource.TransferCommission]: null,
};
