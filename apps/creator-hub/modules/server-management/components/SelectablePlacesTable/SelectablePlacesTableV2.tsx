...
import { PlaceSummaryV2 } from '../../types/PlaceSummary';
import { ServerManagementTabs } from '../TabbedPageManager/TabbedPageManager';
...
const SelectablePlacesTableV2: FunctionComponent<Props> = ({
  ...
  const getPlaceBreakdownTranslation = (servers: number, players: number) => {
    if (servers === 0) return DISPLAY_CONSTANTS.EMPTY_PLACEHOLDER;
                  ...
                  <TableCell className={placesColumn}>
                    <div className={placeRowWithCheckbox}>
                      ...
                      <ListItem
                        ...
                        isContained
                        leading={null}
                        text={translate('SelectablePlacesTable.Cell.PlaceId', {
