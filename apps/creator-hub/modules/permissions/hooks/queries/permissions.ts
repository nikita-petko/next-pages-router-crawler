...
import { RoleApi, UniversesApi } from '@rbx/client-organizations-service-api/v1';
...
async function getUniversePermissionsWithInheritance(
  ...
  const allUniversePermissions = (UniverseMetadata as EntityPermissionsMetadata).flatMap(
        ...
        case EntityTypes.UNIVERSE: {
          ...
          switch (creator.type) {
            case CreatorTypes.ROLE: {
              ...
              return getUniversePermissionsWithInheritance(entity.id, organization.id, creator.id);
            }
