...
const CreatorGroupList: FunctionComponent<CreatorGroupListProps> = ({
  ...
  const { showMobileView } = useUiConfig();
  const { translate } = useTranslationContext();
  const { creatorData, isPending, isError } = useCreators(creatorFilter, entity);
...
export { CreatorGroupList, type CreatorGroupListProps };
