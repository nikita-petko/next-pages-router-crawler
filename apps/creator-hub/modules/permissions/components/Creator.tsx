...
import { getRoleStyle } from '@modules/group/utils/groupUtils';
import { CreatorDetails } from '../utils/types';
...
export const Creator: FunctionComponent<CreatorProps> = ({
    ...
    case CreatorTypes.ROLE:
      startIcon = (
        <SupervisedUserCircleOutlinedIcon
          ...
          style={getRoleStyle(creatorDetails.color)}
        />
      );
      break;
  ...
  return (
    <Button
      ...
      disabled={creatorDetails.disabled || isOwner || false}
