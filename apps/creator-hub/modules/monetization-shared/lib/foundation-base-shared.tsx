...
import type { TListboxOption } from './foundation-listbox';
...
export const TEXT_INPUT_PADDING_X_CLASS_BY_SIZE: Record<TDropdownSize, TTailwindPaddingXClass> = {
...
export const TEXT_INPUT_GAP_X_CLASS_BY_SIZE: Record<TDropdownSize, TTailwindGapXClass> = {
  XSmall: 'gap-x-xsmall',
  Small: 'gap-x-small',
  Medium: 'gap-x-small',
  Large: 'gap-x-small',
...
export const TEXT_INPUT_TEXT_CLASSES_BY_SIZE: Record<
  TDropdownSize,
