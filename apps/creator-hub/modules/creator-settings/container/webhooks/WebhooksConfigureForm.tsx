import { FormMode, Link } from '@modules/miscellaneous/common';
  ...
  const methods = useForm<WebhookFormType>({
    ...
    defaultValues: previousWebhook
      ? {
          ...
          triggers: previousWebhook.eventTypes
            ? previousWebhook.eventTypes.reduce((newTriggers, eventType) => {
                return {
                  ...newTriggers,
                  [eventType]: true,
                };
