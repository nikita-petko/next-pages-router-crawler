...
import { ExperienceGuidelinesServiceAPIApi } from '@rbx/client-experience-guidelines-service/v1';
...
export class ExperienceGuidelinesServiceApiClient {
  ...
  constructor() {
    const configuration = createClientConfiguration('experience-guidelines-service', 'bedev2');
