import type {
  ...
  V1SupportedLanguagesGamesGameIdLanguagesLanguageCodeImageTranslationStatusPatchRequest,
...
} from '@rbx/client-gameinternationalization/v1';
import {
...
} from '@rbx/client-gameinternationalization/v2';
import { SupportedLanguagesV2Api } from '@rbx/client-gameinternationalization/v2';
...
const configuration = createClientConfiguration('gameinternationalization', 'bedev1');
...
export type DisplayInfoAutoTranslationSettingsPatchResponse =
  RobloxGameInternationalizationApiUpdateUniverseDisplayInfoAutomaticTranslationSettingsResponse;
export type ImageTranslationStatusPatchRequest =
  V1SupportedLanguagesGamesGameIdLanguagesLanguageCodeImageTranslationStatusPatchRequest;
export type ImageTranslationStatusPatchResponse =
  RobloxGameInternationalizationApiEditImageTranslationStatusForGameAndLanguageResponse;
...
export interface GameInternationalizationClient {
  ...
  patchImageTranslationStatus(
    request: ImageTranslationStatusPatchRequest,
  ): Promise<ImageTranslationStatusPatchResponse>;
...
const gameInternationalizationClient: GameInternationalizationClient = {
  ...
  async patchImageTranslationStatus(request: ImageTranslationStatusPatchRequest) {
    return supportedLanguagesApiV1.v1SupportedLanguagesGamesGameIdLanguagesLanguageCodeImageTranslationStatusPatch(
      request,
    );
  },
  ...
  async getGamePassNameAndDescription(request: GamePassNameAndDescriptionRequest) {
    // oxlint-disable-next-line no-unsafe-type-assertion -- API return type is structurally compatible
  ...
  async getGameContentTranslationHistory(request: NameDescriptionTranslationHistoryRequest) {
    return nameDescriptionApi.v1NameDescriptionGamesTranslationHistoryPost(request);
  },
};
