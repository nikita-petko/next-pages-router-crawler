import type {
  ...
  BatchArchiveMatchesOperationRequest,
  BatchArchiveMatchesResponse,
  ListIpContentsByAccountRequest,
  SearchQuery,
...
export type { Account, User, Claim, ClaimItem } from '@rbx/client-rights/v1';
...
export class RightsClient {
  ...
  constructor() {
    const defaultConfiguration = createClientConfiguration(
      'rights-management-api/rights/v1',
      'bedev2',
    );
  ...
  checkContentPermissions(
    ...
    contentType: CheckContentPermissionsRequestContentTypeEnum,
  ...
  listIncomingClaimItems(
    ...
    return this.rightsApi.listIncomingClaimItems(request);
  }
  ...
  ): Promise<BatchArchiveMatchesResponse> {
    const request: BatchArchiveMatchesOperationRequest = {
      accountId,
      batchArchiveMatchesRequest: {
        matchIds,
        rationale: rationale ?? '',
        removeConsequences,
      },
    };
    return this.rightsApi.batchArchiveMatches(request);
  }
  ...
  listIpContentsByAccount(params: ListIpContentsByAccountRequest) {
    return this.rightsApi.listIpContentsByAccount(params);
  }
