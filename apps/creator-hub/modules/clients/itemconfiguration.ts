import type {
  ...
  V1CollectiblesCollectibleItemIdRestockPostRequest,
  V1CollectiblesCollectibleItemIdRestockingFeesGetRequest,
  V1CollectiblesCollectibleItemIdRestockEligibilityGetRequest,
...
import type {
  ...
  SaleLocationEnum,
} from '@modules/creations/unifiedFeeSystem/helper/UnifiedFeeSystemConstants';
...
export type { RobloxItemConfigurationApiCollectiblesMetadataResponse as ItemConfigurationCollectiblesMetadataResponse };
export type { RobloxItemConfigurationApiModelsResponseCollectiblesRestockCollectibleItemResponse as RestockCollectibleResponse };
export type { RobloxItemConfigurationApiModelsResponseCollectiblesRestockingFeeResponse as RestockingFeeResponse };
export type { RobloxItemConfigurationApiModelsResponseCollectiblesRestockEligibilityResponse as RestockEligibilityResponse };
...
export class ItemConfigurationClient {
  ...
  restockCollectible(
    ...
    agreedRestockingFee: number,
  ): Promise<RobloxItemConfigurationApiModelsResponseCollectiblesRestockCollectibleItemResponse> {
    const request: V1CollectiblesCollectibleItemIdRestockPostRequest = {
      collectibleItemId,
      request: {
        newTotalQuantity,
        agreedRestockingFee,
    ...
    return this.collectiblesApi.v1CollectiblesCollectibleItemIdRestockPost(request);
  }

  getRestockingFees(
    collectibleItemId: string,
    additionalQuantity: number,
  ): Promise<RobloxItemConfigurationApiModelsResponseCollectiblesRestockingFeeResponse> {
    const request: V1CollectiblesCollectibleItemIdRestockingFeesGetRequest = {
      collectibleItemId,
      additionalQuantity,
    };
    return this.collectiblesApi.v1CollectiblesCollectibleItemIdRestockingFeesGet(request);
  }

  getRestockEligibility(
    collectibleItemId: string,
  ): Promise<RobloxItemConfigurationApiModelsResponseCollectiblesRestockEligibilityResponse> {
    const request: V1CollectiblesCollectibleItemIdRestockEligibilityGetRequest = {
      collectibleItemId,
    };
