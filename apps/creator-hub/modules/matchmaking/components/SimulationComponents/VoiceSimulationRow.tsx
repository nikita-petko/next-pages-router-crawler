...
interface VoiceSimulationRowProps {
  score: number;
  playerCount: number;
  occupancy: number;
  weight: number;
...
const VoiceSimulationRow = function VoiceSimulationRowProps({
  score,
  playerCount,
  occupancy,
  weight,
  onValuesChange,
}: VoiceSimulationRowProps): React.JSX.Element {
  ...
  const toolTipSummary = (
    <Grid item display='flex' direction='column'>
      <Typography variant='tooltip'>{translate('Tooltip.VoiceScore')}</Typography>
...
export default VoiceSimulationRow;
