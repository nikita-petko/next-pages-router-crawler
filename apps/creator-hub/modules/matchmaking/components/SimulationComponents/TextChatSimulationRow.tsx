...
interface TextChatSimulationRowProps {
  score: number;
  playerCount: number;
  occupancy: number;
  weight: number;
...
const TextChatSimulationRow = function TextChatSimulationRowProps({
  score,
  playerCount,
  occupancy,
  weight,
  onValuesChange,
}: TextChatSimulationRowProps): React.JSX.Element {
  ...
  const toolTipSummary = (
    <Grid item display='flex' direction='column'>
      <Typography variant='tooltip'>{translate('Tooltip.TextChatScore')}</Typography>
...
export default TextChatSimulationRow;
