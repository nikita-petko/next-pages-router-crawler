...
interface LanguageSimulationRowProps {
  score: number;
  playerCount: number;
  occupancy: number;
  weight: number;
...
const LanguageSimulationRow = function LanguageSimulationRowProps({
  score,
  playerCount,
  occupancy,
  weight,
  onValuesChange,
}: LanguageSimulationRowProps): React.JSX.Element {
  ...
  const toolTipSummary = (
    <Grid item display='flex' direction='column'>
      <Typography variant='tooltip'>{translate('Tooltip.LanguageScore')}</Typography>
...
export default LanguageSimulationRow;
