...
interface PlayerCategoricalSimulationRowProps {
  score: number;
  playerCount: number;
  occupancy: number;
  weight: number;
...
const PlayerCategoricalSimulationRow = function PlayerCategoricalSimulationRowProps({
  score,
  playerCount,
  occupancy,
  weight,
  distributionType,
  onValuesChange,
}: PlayerCategoricalSimulationRowProps): React.JSX.Element {
      ...
      <Typography variant='body2' whiteSpace='pre-line'>
        {translate(
          distributionType === DistributionType.Cluster
            ? 'Tooltip.DivisionDetails'
            : 'Tooltip.DiversifyDetails',
          {
...
export default PlayerCategoricalSimulationRow;
