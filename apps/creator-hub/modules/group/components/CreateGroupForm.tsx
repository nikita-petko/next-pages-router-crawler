...
import { CreatorType, FormMode, urls } from '@modules/miscellaneous/common';
import { useAuthentication } from '@modules/authentication/providers';
import { economyClient, groupsClient, tryParseResponseError } from '@modules/clients';
import { useMetricsMonitoring } from '@modules/miscellaneous/metricsMonitoring';
import { V1GroupsCreatePostRequest } from '@rbx/clients/groups';
...
import { CreateGroupFormType, GroupIcon } from '../ConfigureGroupTypes';
...
const CreateGroupForm: FunctionComponent<React.PropsWithChildren<CreateGroupFormProps>> = ({
  ...
  const redirectToProfile = useCallback(
    async (groupId: number) => {
      ...
      router.push(urls.creatorHub.dashboard.getGroupProfileUrl(groupId.toString()));
    },
  ...
  const handleFormSubmit: SubmitHandler<CreateGroupFormType> = useCallback(
    ...
    [setFormSubmissionErrorMsg, translate, redirectToProfile],
  );
