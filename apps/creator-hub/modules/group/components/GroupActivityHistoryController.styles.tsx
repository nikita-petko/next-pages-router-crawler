...
const useGroupActivityHistoryControllerStyles = makeStyles()((theme) => {
...
export const filterMenuChoiceStyle = {
  choiceMaxWidth: 200,
};
...
export default useGroupActivityHistoryControllerStyles;
