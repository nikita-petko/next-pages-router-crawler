...
import { ColumnType, ColumnTypesToTranslationKey, ColumnsMap } from '../constants/TableInfo';
      ...
      return (
        <TableRow key={index} data-testid='table-row-id'>
          {columns.map((columnType: ColumnType) => {
            return (
              <PaymentsCell
                // eslint-disable-next-line react/no-array-index-key -- Existing rule by @jjuang
