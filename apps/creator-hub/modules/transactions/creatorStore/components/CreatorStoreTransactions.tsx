...
import {
  RobloxMarketplaceFiatSharedV1Beta1Money as Money,
...
import { OverviewInlineUrlTranslationLabel } from '@modules/creations';
...
const CreatorStoreTransactions: FunctionComponent<React.PropsWithChildren<unknown>> = () => {
