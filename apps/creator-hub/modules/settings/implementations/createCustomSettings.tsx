import type { FunctionComponent, Context } from 'react';
import React, { createContext, useContext, useEffect, useState, useMemo } from 'react';
import type CustomSettingsManager from '../interfaces/CustomSettingsManager';
import type CustomSettingsManagerWithArgs from '../interfaces/CustomSettingsManagerWithArgs';
...
interface CreateCustomSettingsReturnType<T> {
  CustomSettingsProvider: FunctionComponent<React.PropsWithChildren>;
...
export function createCustomSettings<T>(
  ...
  const CustomSettingsProvider: FunctionComponent<React.PropsWithChildren> = ({ children }) => {
