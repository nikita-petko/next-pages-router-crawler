...
import { RAQIV2ChartResourceType, OwnerType } from '@modules/clients/analytics';
import type { AvatarItemType } from '@modules/clients/analytics/avatarItemTypes';
import { AvatarItemTargetType } from '@modules/clients/analytics/avatarItemTypes';
...
const makeGetItemMetadataForSummaryCard =
  ...
  async (breakdowns: RAQIV2BreakdownValue[]): Promise<ItemMetadata> => {
    ...
    const url = getUrlForItemType(itemType, parsed.itemId) ?? undefined;
