...
import { MatchmakingCustomizationApi, GameInstancesApi } from '@rbx/client-matchmaking-api/v1';
...
const configuration = createClientConfiguration('matchmaking-api', 'bedev2');
