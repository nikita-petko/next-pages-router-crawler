/* oxlint-disable rbx/no-hardcoded-translation-string - unsupported broswer is an english own page */
...
const getUnsupportedPageLayout = (page: ReactNode) => <>{page}</>;
...
UnsupportedPage.loggerConfig = { rosId: RosTeams.CreatorHubPlatform };
