...
import { analyticsDataStoresNavigationItem } from '@modules/charts-generic/constants/analyticsNavigationItems';
...
DataStores.loggerConfig = { rosId: RosTeams.CreatorEconomy };
