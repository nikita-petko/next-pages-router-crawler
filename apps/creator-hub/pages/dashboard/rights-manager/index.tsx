...
const getRightsManagementPageLayout = (page: ReactNode) => (
  <IpAppNavigationLayout
    defaultTitle={
      <Translate namespace='CreatorDashboard.RightsPortal' translationKey='Heading.RightsManager' />
    }>
    {page}
  </IpAppNavigationLayout>
);
...
RightsManagement.loggerConfig = { rosId: RosTeams.IntellectualProperty };
