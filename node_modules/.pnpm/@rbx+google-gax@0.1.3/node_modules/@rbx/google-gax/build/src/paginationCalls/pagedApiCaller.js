 ...
 *
 * This file was derived and modified from gax/src/paginationCalls/pagedApiCaller.ts
...
class PagedApiCaller {
    ...
    generateParseResponseCallback(request, callback) {
        ...
        return (err, response) => {
            ...
            if (!request) {
                callback(new openCloudError_1.OpenCloudError('Undefined request in pagination method callback.'));
                return;
            }
            if (!response) {
                callback(new openCloudError_1.OpenCloudError('Undefined response in pagination method callback.'));
                return;
            }
