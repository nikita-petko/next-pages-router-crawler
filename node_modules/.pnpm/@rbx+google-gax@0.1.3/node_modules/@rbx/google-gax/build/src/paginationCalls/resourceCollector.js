 ...
 *
 * This file was derived and modified from gax/src/paginationCalls/resourceCollector.ts
...
class ResourceCollector {
    ...
    callback(err, resources, nextPageRequest) {
        ...
        setTimeout(this.apiCall, 0, nextPageRequest, callback);
    }
    processAllPages(firstRequest) {
        return new Promise((resolve, reject) => {
            ...
            const callback = (...args) => this.callback(...args);
            setTimeout(this.apiCall, 0, firstRequest, callback);
        });
    }
}
