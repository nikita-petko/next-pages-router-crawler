 ...
 *
 * This file was derived and modified from gax/src/bundlingCalls/bundleApiCaller.ts
...
class BundleApiCaller {
    ...
    call(apiCall, argument, settings, status) {
        if (!settings.isBundling) {
            throw new openCloudError_1.OpenCloudError('Bundling enabled with no isBundling!');
        }
