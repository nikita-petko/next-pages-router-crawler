 ...
 *
 * This file was derived and modified from gax/src/call.ts
...
class OngoingCall {
    ...
    call(func, argument) {
        ...
        const canceller = func(argument, (err, response, next, rawResponse) => {
            this.completed = true;
            setTimeout(this.callback, 0, err, response, next, rawResponse);
        });
        if (canceller instanceof Promise) {
            canceller.catch(err => {
                setTimeout(this.callback, 0, new openCloudError_1.OpenCloudError(err), null, null, null);
            });
        }
    ...
    constructor() {
        ...
        const callback = (err, response, next, rawResponse) => {
            if (err) {
                ...
                throw new openCloudError_1.OpenCloudError('Neither error nor response are defined');
            }
        };
