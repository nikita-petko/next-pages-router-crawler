...
export const processSearchResults = (
  ...
  const allResultsByContentType =
    searchResults.length === 0
      ? // eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- empty result
      ...
      : searchResults.reduce((acc, result) => {
          ...
          return acc;
          // eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- accumulator starts empty
        }, {} as TCategorizedSearchResults);
  ...
  // eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- Object.fromEntries loses key type
  ...
  const searchListItems =
    Object.keys(resultsByContentType).length === 0
      ...
      : // eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion -- Object.keys loses key type
