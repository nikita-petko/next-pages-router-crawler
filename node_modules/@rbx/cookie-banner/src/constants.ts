 ...
 */
const REQUIRED_TRANSLATION_NAMESPACES = ['Feature.Tracking', 'CommonUI.Controls'];
...
const GOOGLE_ANALYTICS_URL = 'https://marketingplatform.google.com/about/analytics/';
const GOOGLE_INC = 'Google Inc.';
const GA_READ_MORE_URL = 'https://support.google.com/analytics/answer/11397207';
