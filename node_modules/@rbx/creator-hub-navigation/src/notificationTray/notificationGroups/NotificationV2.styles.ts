...
const useNotificationStyles = makeStyles()((theme) => ({
  ...
  overflowBtnClickable: {
    // oxlint-disable-next-line typescript/no-unsafe-type-assertion -- TODO: 2026/06/17 packages/creator-hub-navigation/src/notificationTray/notificationGroups/NotificationV2.styles.ts
