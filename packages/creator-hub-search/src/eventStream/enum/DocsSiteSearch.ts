...
export enum ESearchEventName {
  ...
  // (2026/06) Store navigation surfaces (Search-in-Store row + category tiles)
  SearchInStoreClicked = 'DocsSearch_SearchInStore_Clicked',
  StoreCategoryTileClicked = 'DocsSearch_StoreCategoryTile_Clicked',
}
