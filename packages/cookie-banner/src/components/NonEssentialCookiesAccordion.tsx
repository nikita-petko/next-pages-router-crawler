...
import { Accordion, AccordionSummary, AccordionDetails, Switch, Typography } from '@rbx/ui';
import { GA_COMPANY_COLLECTION_LIST, GOOGLE_ANALYTICS_URL, GOOGLE_INC } from '../constants';
  ...
  return (
    <Accordion className={classes.accordion}>
      <AccordionSummary className={classes.accordionSummary}>
        <Typography variant='h6'>{translate(TranslationKeys.AnalyticsCookie)}</Typography>
        <Switch
      ...
      <AccordionDetails>
        <CookieItem
          ...
          description={translate(TranslationKeys.RBXViralAcquisitionDescription)}
        />
        <CookieItem
