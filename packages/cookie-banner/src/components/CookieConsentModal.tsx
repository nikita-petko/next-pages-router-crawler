...
const CookieConsentModal: React.FC<CookieConsentModalProps> = ({
  ...
  return (
    <Dialog open={open} onClose={onClose}>
      <DialogTitle>{translate(TranslationKeys.ConsentToolModalTitle)}</DialogTitle>
      <DialogContent className={classes.dialogContent}>
        <Typography variant='h6'>{translate(TranslationKeys.InfoCollectionHeader)}</Typography>
        <Typography variant='body2' paragraph className={classes.paragraph} color='secondary'>
          {translate(TranslationKeys.InfoCollectionContent)}
        </Typography>
        <Typography variant='h6'>{translate(TranslationKeys.InfoCollectionHeader2)}</Typography>
        <Typography variant='body2' paragraph className={classes.paragraph} color='secondary'>
        ...
        <ServiceLink href={REQUEST_DATA_URL} text={translate(TranslationKeys.RequestData)} />
        <ServiceLink href={PRIVACY_POLICY_URL} text={translate(TranslationKeys.PrivacyPolicy)} />
