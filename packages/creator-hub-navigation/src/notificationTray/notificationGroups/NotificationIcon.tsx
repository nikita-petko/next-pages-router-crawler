...
const NOTIFICATION_ICON_MAP: Record<string, React.JSX.Element> = {
  ...
  GiftBoxRegular: <FoundationIcon name='icon-regular-gift-box' size='XLarge' />,
};
...
const NotificationIcon: React.FC<NotificationIconProps> = ({
  ...
  // oxlint-disable-next-line react/no-clone-element -- Map values are pre-constructed elements (MUI or Foundation) and need a uniform alt + fontSize override at the call site.
