...
import type { MapChartLegendLabelFormatter } from './highchart-options/legendCreditAndTitleOptions';
import { useMapChartLegendTitleAndCreditOptions } from './highchart-options/legendCreditAndTitleOptions';
