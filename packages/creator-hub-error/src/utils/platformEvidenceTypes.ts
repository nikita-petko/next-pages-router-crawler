import { z } from 'zod';
import type { HttpControllerGetNotApprovedResponseViolationEvidence } from '@rbx/client-behavior-intervention/v1';
...
export const isPlatformEvidence = (
  ...
  // @ts-expect-error For reasons, the lint/test runs TS from the base folder, which is incompatible with zod
