...
export const ROBLOX_ACCOUNT_COUNTRIES = [
...
interface CountryFormOptionObj {
  title: string;
  value: string;
}

export const GetCountryObjFromCountryCode = (countryCode: string) =>
  ROBLOX_ACCOUNT_COUNTRIES.find((czObj: CountryFormOptionObj) => czObj.value === countryCode);

export const getLocalizedCountryName = (countryCode: string, locale: string): string => {
  try {
...
export const getLocalizedCountries = (locale: string): CountryFormOptionObj[] =>
  ROBLOX_ACCOUNT_COUNTRIES.map((country) => ({
    title: getLocalizedCountryName(country.value, locale),
    value: country.value,
