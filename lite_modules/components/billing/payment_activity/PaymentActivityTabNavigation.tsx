import { Tabs, TabsList } from '@rbx/foundation-ui';
...
const PaymentActivityTabsNavigation = ({
  ...
  const handleChangeTab = (newValue: string) => {
    changeTabCb(Number(newValue) as PaymentActivityTabType);
  };
  ...
  return (
    <div className='flex flex-col width-full' data-testid='paymentActivityTabNavigation'>
      <Tabs onValueChange={handleChangeTab} value={String(visibleValue)} variant='Inlined'>
        <TabsList>
          {showCardTab ? (
            <PaymentActivityTab
