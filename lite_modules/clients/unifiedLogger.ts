...
export enum EventName {
  ...
  CreativeLibraryFeedbackBannerShown = 'creativeLibraryFeedbackBannerShown',
  CreativeLibraryFeedbackSubmitted = 'creativeLibraryFeedbackSubmitted',
  ...
  ToggleAttributionThumbnailDrawer = 'toggleAttributionThumbnailDrawer',
